...
def post_init_hook(*args):
    ...
    try:
        ...
        module = env['ir.module.module'].sudo().search([('name', '=', 'connect_crm')], limit=1)
        ...
        if module:
            ...
            _logger.info('Connect Crm module installation date updated for trial period')
        else:
            _logger.warning('Connect Crm module not found in ir.module.module')
