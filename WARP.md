...
This is an Odoo addons repository for **Oduist Connect**, a comprehensive telephony integration suite that connects Odoo with Twilio for voice calls, SMS, and AI-powered phone services. The codebase consists of multiple interconnected Odoo modules targeting version 17.0, with support for versions 16.0-19.0.
...
odoo --dev=all -d <database> --addons-path=/path/to/connect_addons/17.0
```
...
### Version Management
- This is the 17.0 branch - other versions maintained in separate worktrees
- Check `.git/worktrees/` for 16.0, 18.0, 19.0 parallel development branches
