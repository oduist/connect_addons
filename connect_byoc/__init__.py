...
def post_init_hook(*args):
    ...
    try:
        ...
        module = env['ir.module.module'].sudo().search([('name', '=', 'connect_byoc')], limit=1)
        ...
        if module:
            ...
            _logger.info('Connect Byoc module installation date updated for trial period')
        else:
            _logger.warning('Connect Byoc module not found in ir.module.module')
